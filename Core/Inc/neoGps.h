...
//define area
#define UART_GPS_MSG_SIZE        256u     //max size of gps uart message
#define GPS_VAR_LEN              8u      //buff size for storing gps variables

# define GPS_SENTENCELENGTH      6u
# define GPS_GPGGA               (uint8_t*)("$GPGGA")
# define GPS_GPRMC               (uint8_t*)("$GPRMC")
...
extern uint8_t lonGpsBuff[GPS_VAR_LEN];
extern uint8_t latGpsBuff[GPS_VAR_LEN];
extern uint8_t timeGpsBuff[GPS_VAR_LEN];
